...
OUTPUT_DIR="${OUTPUT_DIR:-/data3/leics/dataset/checkpoints/Gendental/stage_one_zj_old_stochastic}"
CKPT_PATH="${CKPT_PATH:-/data3/leics/dataset/checkpoints/ToothWise/stage_one_zj_old_stochastic/ckpt/last.ckpt}"
