...
OUTPUT_DIR="${OUTPUT_DIR:-/data3/leics/dataset/checkpoints/Gendental/PSTN5x}"
CKPT_PATH="${CKPT_PATH-}"
INIT_CKPT="${INIT_CKPT:-/data3/leics/dataset/checkpoints/Gendental/PSTN1x_2/ckpt/last.ckpt}"
