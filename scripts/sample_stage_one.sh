...
CKPT_PATH="${CKPT_PATH:-/data3/leics/dataset/checkpoints/Gendental/stage_one_zj_old_stochastic/ckpt/last.ckpt}"
OUTPUT_DIR="${OUTPUT_DIR:-/data3/leics/dataset/GenDental/old_gpt_stochastic_samples2}"
NUM_SAMPLES="${NUM_SAMPLES:-3735}"
...
CENTER_MODE="${CENTER_MODE:-reference}"
